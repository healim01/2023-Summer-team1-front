  ...
  return (
    <AddFund>
        ...
        <FormContainer onSubmit={0}>
            ...
            <Container>
                <Label> 프로젝트 예산 </Label>
                <TextArea type="text" name="budget" placeholder="펀딩 목표 금액을 제작에 어떻게 사용할 것인지 구체적으로 알려주세요." required />  
            </Container>
            <Hr />
            <Container>
                <Label> 프로젝트 일정 </Label>
            ...
            <CheckForm>
                ...
                <FormControlLabel required control={<Checkbox />} label="펀디깅에서 필요 시 연락 드릴 수 있도록 본인 명의의 휴대폰 번호와 이메일 주소가 필요합니다." />    
                <FormControlLabel required control={<Checkbox />} label="펀딩 성공 후의 정산을 위해 신분증 또는 사업자 등록증, 국내 은행 계좌를 준비해주세요." />    
            </CheckForm>
            <FormButtons>
                <FormButton bgColor="lightgray" color="black" type="cancel"> 이전으로 </FormButton>
                <FormButton bgColor="#78C1F3" color="white" type="submit"> 등록하기 </FormButton>
            </FormButtons>
        </FormContainer>
    </AddFund>
  );
